// FILE: src/components/Assistant/generators/GeneratorOrchestrator.jsx
...
// [UPDATE] Ubah import ini ke './Chapter2' (otomatis ambil index.jsx)
import Chapter2Generator from './Chapter2'; 
...
const GeneratorOrchestrator = (props) => {
    ...
    const currentChapterNum = useMemo(() => {
        ...
        // Deteksi Keyword Judul Bab
        if (title.includes('pendahuluan') || title.includes('introduction')) return 1;
        if (title.includes('pustaka') || title.includes('literature') || title.includes('kajian')) return 2;
        ...
        // Fallback: Cek string angka di ID (misal: "chap-1-xyz")
    ...
    const renderModule = () => {
        switch (currentChapterNum) {
            ...
            case 2: return <Chapter2Generator {...props} context={project} />; // [UPDATE] Pakai Generator Baru
